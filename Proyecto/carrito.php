...
<body>
    ...
    <div class="hero">
            <h2 class="titulo">Bienvenido a la experiencia del cine</h2>
    </div>
    
    <div class="hero">
        <h3 class="cuerpo">Nosotros somos una empresa dedicada a la distribucion de copias 
                           digitales y fisicas de peliculas</h3>
    </div>
